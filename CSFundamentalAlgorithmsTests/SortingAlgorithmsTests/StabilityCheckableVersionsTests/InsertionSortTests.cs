...
namespace CSFundamentalAlgorithmsTests.SortingAlgorithmsTests
{
    public partial class InsertionSortTests
    {
        ...
        public void InsertionSort_IsStable_Test()
        {
            ...
            bool isStable1 = Utils.IsSortMethodStable(InsertionSort.InsertionSort_Iterative_V2, duplicateValuesElements1);
            ...
            bool isStable2 = Utils.IsSortMethodStable(InsertionSort.InsertionSort_Iterative_V2, duplicateValuesElements2);
            ...
            bool isStable3 = Utils.IsSortMethodStable(InsertionSort.InsertionSort_Iterative_V2, duplicateValuesElements3);
            ...
            bool isStable4 = Utils.IsSortMethodStable(InsertionSort.InsertionSort_Iterative_V2, duplicateValuesElements4);
            ...
            bool isStable5 = Utils.IsSortMethodStable(InsertionSort.InsertionSort_Iterative_V2, duplicateValuesElements5);
