...
namespace CSFundamentalsTests.DataStructures.Trees.Nary
{
    ...
    public class _2_3_BTreeTests
    {
        /// <summary>
        /// Is a B tree. 
        /// To visualize this tree built as in <see cref="Initialize()"/> method, see <a href="file:///C:\Users\Parisa\Documents\Interviews-2019\CSFundamentalAlgorithms\Tests\DataStructures\Trees\Nary\Images\2-3-BTree.png"/> "Images\2-3-BTree.png" in current directory. 
        /// </summary>
        ...
        /// For a step by step transition of this 2-3 BTree while inserting these keys, see "images\2-3-BTree-insert-stepBystep.png".
        /// </summary>
        [TestMethod]
        ...
        /// For a step by step transition of this 2-3 BTree while deleting these keys, see "images\2-3-BTree-delete-stepBystep.png".
        /// </summary>
        [TestMethod]
