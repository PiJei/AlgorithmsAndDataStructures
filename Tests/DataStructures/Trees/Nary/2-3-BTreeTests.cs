...
namespace CSFundamentalsTests.DataStructures.Trees.Nary
{
    ...
    public class _2_3_BTreeTests
    {
        ...
        {
            BTreeTestsUtils.HasBTreeProperties(_tree, 16, 15);
        }
        ...
        public void Insert_SeveralKeys_ExpectsTreeToIncreaseInLevelsAfewTimes()
        {
            ...
            BTreeTestsUtils.HasBTreeProperties(tree, 0, 0);

            tree.Insert(new KeyValuePair<int, string>(50, "A"));
            BTreeTestsUtils.HasBTreeProperties(tree, 1, 1);

            tree.Insert(new KeyValuePair<int, string>(10, "B"));
            BTreeTestsUtils.HasBTreeProperties(tree, 2, 1);

            tree.Insert(new KeyValuePair<int, string>(100, "C"));
            BTreeTestsUtils.HasBTreeProperties(tree, 3, 3);

            tree.Insert(new KeyValuePair<int, string>(200, "D"));
            BTreeTestsUtils.HasBTreeProperties(tree, 4, 3);

            tree.Insert(new KeyValuePair<int, string>(20, "E"));
            BTreeTestsUtils.HasBTreeProperties(tree, 5, 3);

            tree.Insert(new KeyValuePair<int, string>(300, "F"));
            BTreeTestsUtils.HasBTreeProperties(tree, 6, 4);

            tree.Insert(new KeyValuePair<int, string>(30, "G"));
            BTreeTestsUtils.HasBTreeProperties(tree, 7, 7);

            tree.Insert(new KeyValuePair<int, string>(500, "H"));
            BTreeTestsUtils.HasBTreeProperties(tree, 8, 7);

            tree.Insert(new KeyValuePair<int, string>(250, "I"));
            BTreeTestsUtils.HasBTreeProperties(tree, 9, 8);

            tree.Insert(new KeyValuePair<int, string>(400, "J"));
            BTreeTestsUtils.HasBTreeProperties(tree, 10, 8);

            tree.Insert(new KeyValuePair<int, string>(270, "K"));
            BTreeTestsUtils.HasBTreeProperties(tree, 11, 8);

            tree.Insert(new KeyValuePair<int, string>(600, "L"));
            BTreeTestsUtils.HasBTreeProperties(tree, 12, 10);

            tree.Insert(new KeyValuePair<int, string>(150, "M"));
            BTreeTestsUtils.HasBTreeProperties(tree, 13, 10);

            tree.Insert(new KeyValuePair<int, string>(80, "N"));
            BTreeTestsUtils.HasBTreeProperties(tree, 14, 11);

            tree.Insert(new KeyValuePair<int, string>(60, "O"));
            BTreeTestsUtils.HasBTreeProperties(tree, 15, 11);

            tree.Insert(new KeyValuePair<int, string>(90, "P"));
            BTreeTestsUtils.HasBTreeProperties(tree, 16, 15);
        ...
        public void Delete_Root_ExpectsToReduceBy4NodesAnd1Key()
        {
            ...
            BTreeTestsUtils.HasBTreeProperties(_tree, 15, 11);
        }
        ...
        public void Delete_TheOnlyKeyOfRightChildOfRoot_ExpectsToReduceBy1Key()
        {
            ...
            BTreeTestsUtils.HasBTreeProperties(_tree, 15, 15);
        }
        ...
        public void Delete_AllNodesInRandomOrder1_ExpectsProperBtreeAfterEachDelete()
        {
            ...
            Assert.IsTrue(_tree.Delete(20));
            BTreeTestsUtils.HasBTreeProperties(_tree, 14, 10);

            Assert.IsTrue(_tree.Delete(250));
            BTreeTestsUtils.HasBTreeProperties(_tree, 13, 10);

            Assert.IsTrue(_tree.Delete(600));
            BTreeTestsUtils.HasBTreeProperties(_tree, 12, 8);

            Assert.IsTrue(_tree.Delete(270));
            BTreeTestsUtils.HasBTreeProperties(_tree, 11, 8);

            Assert.IsTrue(_tree.Delete(60));
            BTreeTestsUtils.HasBTreeProperties(_tree, 10, 8);

            Assert.IsTrue(_tree.Delete(10));
            BTreeTestsUtils.HasBTreeProperties(_tree, 9, 8);

            Assert.IsTrue(_tree.Delete(300));
            BTreeTestsUtils.HasBTreeProperties(_tree, 8, 7);

            Assert.IsTrue(_tree.Delete(80));
            BTreeTestsUtils.HasBTreeProperties(_tree, 7, 4);

            Assert.IsTrue(_tree.Delete(150));
            BTreeTestsUtils.HasBTreeProperties(_tree, 6, 4);

            Assert.IsTrue(_tree.Delete(400));
            BTreeTestsUtils.HasBTreeProperties(_tree, 5, 4);

            Assert.IsTrue(_tree.Delete(30));
            BTreeTestsUtils.HasBTreeProperties(_tree, 4, 3);

            Assert.IsTrue(_tree.Delete(90));
            BTreeTestsUtils.HasBTreeProperties(_tree, 3, 3);

            Assert.IsTrue(_tree.Delete(500));
            BTreeTestsUtils.HasBTreeProperties(_tree, 2, 1);

            Assert.IsTrue(_tree.Delete(50));
            BTreeTestsUtils.HasBTreeProperties(_tree, 1, 1);

            Assert.IsTrue(_tree.Delete(200));
            BTreeTestsUtils.HasBTreeProperties(_tree, 0, 0);
        }
        ...
        public void Delete_AllNodesInRandomOrder2_ExpectsProperBtreeAfterEachDelete()
        {
            ...
            Assert.IsTrue(_tree.Delete(400));
            BTreeTestsUtils.HasBTreeProperties(_tree, 14, 9);

            Assert.IsTrue(_tree.Delete(80));
            BTreeTestsUtils.HasBTreeProperties(_tree, 13, 9);

            Assert.IsTrue(_tree.Delete(600));
            BTreeTestsUtils.HasBTreeProperties(_tree, 12, 9);
        ...
        public void Delete_TheOnlyKeyInLeafWithFullParentAndMinOneFullSibling_ExpectsLeftRotateAndToReduceBy1Key()
        {
            ...
            BTreeTestsUtils.HasBTreeProperties(tree, 7, 4);
