...
namespace CSFundamentalsTests.DataStructures.Trees.Nary
{
    ...
    public class _2_3_BTreeTests
    {
        ...
        {
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 16, 15));
        }
        ...
        public void Insert_SeveralKeys_ExpectsTreeToIncreaseInLevelsAfewTimes()
        {
            ...
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 0, 0));

            tree.Insert(new KeyValuePair<int, string>(50, "A"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 1, 1));

            tree.Insert(new KeyValuePair<int, string>(10, "B"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 2, 1));

            tree.Insert(new KeyValuePair<int, string>(100, "C"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 3, 3));

            tree.Insert(new KeyValuePair<int, string>(200, "D"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 4, 3));

            tree.Insert(new KeyValuePair<int, string>(20, "E"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 5, 3));

            tree.Insert(new KeyValuePair<int, string>(300, "F"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 6, 4));

            tree.Insert(new KeyValuePair<int, string>(30, "G"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 7, 7));

            tree.Insert(new KeyValuePair<int, string>(500, "H"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 8, 7));

            tree.Insert(new KeyValuePair<int, string>(250, "I"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 9, 8));

            tree.Insert(new KeyValuePair<int, string>(400, "J"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 10, 8));

            tree.Insert(new KeyValuePair<int, string>(270, "K"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 11, 8));

            tree.Insert(new KeyValuePair<int, string>(600, "L"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 12, 10));

            tree.Insert(new KeyValuePair<int, string>(150, "M"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 13, 10));

            tree.Insert(new KeyValuePair<int, string>(80, "N"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 14, 11));

            tree.Insert(new KeyValuePair<int, string>(60, "O"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 15, 11));

            tree.Insert(new KeyValuePair<int, string>(90, "P"));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 16, 15));
        ...
        public void Delete_Root_ExpectsToReduceBy4NodesAnd1Key()
        {
            ...
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 15, 11));
        }
        ...
        public void Delete_TheOnlyKeyOfRightChildOfRoot_ExpectsToReduceBy1Key()
        {
            ...
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 15, 15));
        }
        ...
        public void Delete_AllNodesInRandomOrder1_ExpectsProperBtreeAfterEachDelete()
        {
            ...
            Assert.IsTrue(_tree.Delete(20));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 14, 10));

            Assert.IsTrue(_tree.Delete(250));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 13, 10));

            Assert.IsTrue(_tree.Delete(600));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 12, 8));

            Assert.IsTrue(_tree.Delete(270));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 11, 8));

            Assert.IsTrue(_tree.Delete(60));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 10, 8));

            Assert.IsTrue(_tree.Delete(10));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 9, 8));

            Assert.IsTrue(_tree.Delete(300));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 8, 7));

            Assert.IsTrue(_tree.Delete(80));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 7, 4));

            Assert.IsTrue(_tree.Delete(150));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 6, 4));

            Assert.IsTrue(_tree.Delete(400));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 5, 4));

            Assert.IsTrue(_tree.Delete(30));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 4, 3));

            Assert.IsTrue(_tree.Delete(90));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 3, 3));

            Assert.IsTrue(_tree.Delete(500));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 2, 1));

            Assert.IsTrue(_tree.Delete(50));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 1, 1));

            Assert.IsTrue(_tree.Delete(200));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 0, 0));
        }
        ...
        public void Delete_AllNodesInRandomOrder2_ExpectsProperBtreeAfterEachDelete()
        {
            ...
            Assert.IsTrue(_tree.Delete(400));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 14, 9));

            Assert.IsTrue(_tree.Delete(80));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 13, 9));

            Assert.IsTrue(_tree.Delete(600));
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(_tree, 12, 9));
        ...
        public void Delete_TheOnlyKeyInLeafWithFullParentAndMinOneFullSibling_ExpectsLeftRotateAndToReduceBy1Key()
        {
            ...
            Assert.IsTrue(BTreeTestsUtils<BTreeNode<int, string>, int, string>.HasBTreeProperties(tree, 7, 4));
