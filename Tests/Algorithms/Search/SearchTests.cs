...
namespace CSFundamentalsTests.Algorithms.Search
{
    public class SearchTests
    {
        ...
        /// </summary>
        private static readonly List<int> _values = new List<int> { 1, 3, 10, 14, 25, 27, 34, 78, 90, 90, 120 };
        ...
        {
            Assert.AreEqual(0, search(_values, _startIndex, _endIndex, 1));
            Assert.AreEqual(1, search(_values, _startIndex, _endIndex, 3));
            Assert.AreEqual(2, search(_values, _startIndex, _endIndex, 10));
            Assert.AreEqual(3, search(_values, _startIndex, _endIndex, 14));
            Assert.AreEqual(4, search(_values, _startIndex, _endIndex, 25));
            Assert.AreEqual(5, search(_values, _startIndex, _endIndex, 27));
            Assert.AreEqual(6, search(_values, _startIndex, _endIndex, 34));
            Assert.AreEqual(7, search(_values, _startIndex, _endIndex, 78));
            Assert.AreEqual(10, search(_values, _startIndex, _endIndex, 120));
        }
        ...
        {
            Assert.AreEqual(8, search(_values, _startIndex, _endIndex, 90));
            Assert.AreEqual(8, search(_values, _startIndex, _endIndex, 90));
        }
