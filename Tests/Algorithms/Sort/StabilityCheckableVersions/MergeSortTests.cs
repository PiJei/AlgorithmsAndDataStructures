...
namespace AlgorithmsAndDataStructuresTests.Algorithms.Sort
{
    public partial class MergeSortTests
    {
        ...
        public void IsStable()
        {
            ...
            bool isStable1 = Utils.IsSortMethodStable(MergeSort.MergeSort_Recursively_Wrapper, duplicateValuesElements1);
            ...
            bool isStable2 = Utils.IsSortMethodStable(MergeSort.MergeSort_Recursively_Wrapper, duplicateValuesElements2);
            ...
            bool isStable3 = Utils.IsSortMethodStable(MergeSort.MergeSort_Recursively_Wrapper, duplicateValuesElements3);
            ...
            bool isStable4 = Utils.IsSortMethodStable(MergeSort.MergeSort_Recursively_Wrapper, duplicateValuesElements4);
            ...
            bool isStable5 = Utils.IsSortMethodStable(MergeSort.MergeSort_Recursively_Wrapper, duplicateValuesElements5);
